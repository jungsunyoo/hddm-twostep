...
class HDDMrl_bayesianQ(HDDM):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(HDDMrl_bayesianQ, self).__init__(*args, **kwargs)
    ...
    def _create_stochastic_knodes(self, include):
        ...
        knodes = super(HDDMrl_bayesianQ, self)._create_stochastic_knodes(include)
    ...
    def _create_wfpt_parents_dict(self, knodes):
        ...
        wfpt_parents = super(HDDMrl_bayesianQ, self)._create_wfpt_parents_dict(knodes)
...
def wienerRL_like_bayesianQ(x, v0, v1, v2, v_interaction, z0, z1, z2, z_interaction, lambda_, alpha, pos_alpha, gamma, a, z,
                        t, v, a_2, z_2, t_2, v_2, alpha2,
                        two_stage, w, w2, z_scaler, z_sigma, z_sigma2, window_start, window_size, beta_ndt, beta_ndt2, beta_ndt3,
                        p_outlier=0):  # regression ver2: bounded, a fixed to 1
