...
from wfpt import wiener_like_rlddm, wiener_like_rlddm_2step_reg, like_rl_2step#, wiener_like_rlddm_2step_reg_sliding_window # wiener_like_rlddm_2step,
...
WienerRL = stochastic_from_dist("RL_2step", like_rl_2step)